...
export default function Home() {
  return (
    <main className="relative flex flex-col items-center flex-1 w-full h-full">
      ...
      {/* Overlay */}
      <div className="absolute inset-0 z-10 bg-gradient-to-b from-white via-black/10 to-white dark:from-neutral-950 dark:via-neutral-950/90 dark:to-neutral-950" />
